            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="text-center">
                        <small>Début: <?php echo date("d/m/Y", strtotime($client["start"])) ?></small></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-center">
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target=".bd-example-modal-sm">Supprimer
                                </button>
                            </p>
                                ...
                                <div class="modal-dialog modal-sm modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-footer">
                                            ...
                                            <a href="/client/delete.php?id=<?php echo $client['id'] ?>"
                                            ...
                                            <a href="<?php echo $row['url'] ?>">
                                                <small><?php echo substr($row['filename'], strlen($row['filename']) - 18, strlen($row['filename'])) ?></small><a>
                                                    <input type="hidden" value="<?php echo $row['filename'] ?>"
                                                           name='file_name[]'>
                                                    <input type="hidden" value="<?php echo $row['url'] ?>"
                                                           name='file_url[]'>
                                        </td>
                                        <td><span class="btn btn-danger btn-sm remove"><i
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <input name="firstName" value="<?php echo $client['firstName']; ?>" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="birthday" class="form-control datepicker"
                               value="<?php echo $client['birthday']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="arrived">Date d'arrivée au Quebec</label>
                        <input type="text" name="arrived" class="form-control datepicker"
                               value="<?php echo $client['arrived']; ?>">
                    </div>
                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <?php foreach ($client['table1'] as $row): ?>
                                <tr>
                                    ...
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tb'])) ?>" type="text"
                                               name="table1_b[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tc'])) ?>" type="text"
                                               name="table1_c[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo $row['td'] ?>" type="text" name="table1_d[]"
                                               class="form-control"></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-xs remove"><span
                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <?php foreach ($client['table2'] as $row): ?>
                                <tr>
                                    ...
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tb'])) ?>" type="text"
                                               name="table2_b[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tc'])) ?>" type="text"
                                               name="table2_c[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo $row['td'] ?>" type="text" name="table2_d[]"
                                               class="form-control"></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-xs remove"><span
                                                    class="fas fa-trash"></span></button>
                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <?php foreach ($client['table3'] as $row): ?>
                                <tr>
                                    ...
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tb'])) ?>" type="text"
                                               name="table3_b[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tc'])) ?>" type="text"
                                               name="table3_c[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo $row['td'] ?>" type="text" name="table3_d[]"
                                               class="form-control"></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-xs remove"><span
                                                    class="fas fa-trash"></span></button>
                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <?php foreach ($client['table4'] as $row): ?>
                                <tr>
                                    ...
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tb'])) ?>" type="text"
                                               name="table4_b[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tc'])) ?>" type="text"
                                               name="table4_c[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo $row['td'] ?>" type="text" name="table4_d[]"
                                               class="form-control"></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-xs remove"><span
                                                    class="fas fa-trash"></span></button>
                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <?php foreach ($client['table5'] as $row): ?>
                                <tr>
                                    ...
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tb'])) ?>" type="text"
                                               name="table5_b[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tc'])) ?>" type="text"
                                               name="table5_c[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo $row['td'] ?>" type="text" name="table5_d[]"
                                               class="form-control"></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-xs remove"><span
                                                    class="fas fa-trash"></span></button>
                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <?php foreach ($client['table6'] as $row): ?>
                                <tr>
                                    ...
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tb'])) ?>" type="text"
                                               name="table6_b[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo date("d/m/Y", strtotime($row['tc'])) ?>" type="text"
                                               name="table6_c[]" class="form-control datepicker"></td>
                                    <td><input value="<?php echo $row['td'] ?>" type="text" name="table6_d[]"
                                               class="form-control"></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-xs remove"><span
                                                    class="fas fa-trash"></span></button>
                    ...
                    <div class="row">
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <?php foreach ($client['table7'] as $row): ?>
                                <tr>
                                    <td><input value="<?php echo $row['ta']; ?>" type="text" name="table7_a[]"
                                               class="form-control datepicker"></td>
                                    <td><input value="<?php echo $row['tb']; ?>" type="text" name="table7_b[]"
                                               class="form-control"></td>
                                    <td><input value="<?php echo $row['tc']; ?>" type="text" name="table7_c[]"
                                               class="form-control"></td>
                                    <td><input value="<?php echo $row['td']; ?>" type="text" name="table7_d[]"
                                               class="form-control"></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-xs remove"><span
                                                    class="fas fa-trash"></span></button>
